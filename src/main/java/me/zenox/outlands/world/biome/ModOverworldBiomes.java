...
public class ModOverworldBiomes {
    ...
    public static Biome outlands() {
        ...
        return new Biome.Builder().precipitation(Biome.Precipitation.NONE).temperature(2F).downfall(2f).effects((new BiomeEffects.Builder()).waterColor(4159204).waterFogColor(329011).fogColor(0x423961).skyColor(0).moodSound(BiomeMoodSound.CAVE).build()).spawnSettings(spawnBuilder.build()).generationSettings(biomeBuilder.build()).build();
    }
